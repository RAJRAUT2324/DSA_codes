...
using namespace std;
//sorting in stack
bool sorting(stack<int> &s, int prev)
{
    // base case
    if (s.empty())
    {
    ...
    return sorting(s, next);   // ✔️ no need for else
}
...
int main() {
	...
	// }
	cout << endl;
	cout<<"print array is sorted or not : "<<sorting(s,INT_MIN);
